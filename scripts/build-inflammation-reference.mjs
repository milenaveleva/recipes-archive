...
import { valueOf as valueOfShared, rawFII as rawFIIof } from './lib/fii.mjs';
...
const out = {
  _doc: 'GENERATED by scripts/build-inflammation-reference.mjs — do not hand-edit. Open reference distribution for the FII (src/core/fii.ts): per-nutrient robust centre/scale, and the corpus centre/scale of the raw FII used to standardise a per-food score onto the −2…+2 axis.',
