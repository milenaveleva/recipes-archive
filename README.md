...
- **Phase 2 (done)** — every recipe is scored in-app: a carb-weighted composite **glycemic index/load** (GI values transcribed from Atkinson 2021), the general-foods **Nutri-Score 2023** grade, a composition-derived **Food Inflammation Index** (per-food inflammatory potential from fat quality, fibre, antioxidant micronutrients and polyphenols, energy-weighted across the recipe), and a 1–10 **nutrient-balance score** (the NRF9.3 nutrient-density index per 100 kcal). Scores are precomputed at author time into the markdown and shown as medallions.
