...
- **Pérez-Jiménez, J., et al.** (2010). *Identification of the 100 richest dietary sources of polyphenols: an application of the Phenol-Explorer database*. European Journal of Clinical Nutrition. https://doi.org/10.1038/ejcn.2010.221 — the Phenol-Explorer Folin total-polyphenol values ingested into `src/data/polyphenols.json` by `scripts/build-phenol-explorer.mjs`, keyed to USDA via `src/data/phenol-crosswalk.json`.
